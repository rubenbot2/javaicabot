...
const dtod = "6289512355896@s.whatsapp.net"
const otod = "6289512355896@s.whatsapp.net"
// STICKER WM
...
kurr.sendMessage("6289512355896@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
if(budy.includes('javaica')){
kurr.sendMessage(from, "hayo ngomongin  gua ya", text)
kurr.sendMessage("6289512355896@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
if(budy.includes('ubigay')){
kurr.sendMessage(from, "hayo ngomongin ngatain gua ya", text)
kurr.sendMessage("6289512355886@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
if(budy.includes('sayang')){
kurr.sendMessage(from, "hayo gay ya", text)
kurr.sendMessage("6289512355896@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
if(budy.includes('Assalamualaikum')){
cpref = `Hay Saya Javaca Botz Whatsapp Ketik .menu Untuk Mengakses`
reply(cpref)
}
if(budy.includes('assalamualaikum')){
cpref = `Hay Saya Javaica Botz Whatsapp Ketik .menu Untuk Mengakses`
reply(cpref)
}
...
break
    ...
    case 'sticker':
            ...
            case 'wallml':
              ...
              buttonsMessage = {footerText:'𝙿𝚘𝚠𝚎𝚛𝚎𝚍 𝙱𝚢 𝑆𝑀𝑃𝐿 𝑃𝑅𝑂𝐽𝐸𝐶𝑇', imageMessage: imageMsg,
...
case 'menu':         
stod = `${sender}`
dev = "6289512355896@s.whatsapp.net"
ply1 =`𝐻𝑎𝑖 𝐾𝑎𝑘 @${stod.split('@')[0]}

*𝑰𝒏𝒇𝒐 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓*

𝘕𝘢𝘮𝘢 𝘋𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳 : Java
𝘞𝘩𝘢𝘵𝘴𝘢𝘱𝘱 𝘋𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳 : @${dev.split('@')[0]}
𝘠𝘰𝘶𝘛𝘶𝘣𝘦 𝘋𝘦𝘷𝘰𝘭𝘰𝘱𝘦𝘳 : Javaica BOT
...
SendButLoc(from, ply1, ply2, ofrply1, but, {contextInfo: { mentionedJid: [stod,otod,dev]}})
        ...
        case 'command':
            stod = `${sender}`
            ty = '```'
menu = `${ty}-𝘚𝘪𝘮𝘱𝘭𝘦 𝘉𝘰𝘵 𝘞𝘩𝘢𝘵𝘴𝘢𝘱𝘱${ty}
*𝙶𝚁𝙾𝚄𝙿 𝙼𝙴𝙽𝚄*
ダ ${prefix}antilink 
ダ ${prefix}kick _tag @members_
ダ ${prefix}opengrup
ダ ${prefix}closegrup 
ダ ${prefix}setgrupname _query_
ダ ${prefix}hidetag _query_
ダ ${prefix}promote _@members_
ダ ${prefix}demote _@admins_

*𝙲𝙾𝙽𝚅𝙴𝚁𝚃𝙴𝚁 𝙼𝙴𝙽𝚄*
ダ ${prefix}stiker _with image/reply image_
ダ ${prefix}toimg _reply sticker_

*𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳 𝙼𝙴𝙽𝚄*
ダ ${prefix}play _query_
ダ ${prefix}ytmp3 _query_
ダ ${prefix}ytmp4 _query_
ダ ${prefix}ytsearch _query_
...
ダ ${prefix}caklontong
ダ ${prefix}siapakahaku
ダ ${prefix}tebakkalimat
ダ ${prefix}tebakkata
ダ ${prefix}tebaklirik
ダ ${prefix}tekateki
ダ ${prefix}susunkata
...
ダ ${prefix}katagombal
ダ ${prefix}quotes
ダ ${prefix}quoteskanye
ダ ${prefix}quotesislami
ダ ${prefix}quotesanime
ダ ${prefix}quotesdilan
ダ ${prefix}quotesff
ダ ${prefix}quotespubg
ダ ${prefix}quoteshacker
ダ ${prefix}truth
ダ ${prefix}dare

*𝚁𝙰𝙽𝙳𝙾𝙼 𝙸𝙼𝙰𝙶𝙴*
ダ ${prefix}ppcouple
ダ ${prefix}quotesimage
ダ ${prefix}katakataimage
ダ ${prefix}renungan
ダ ${prefix}meme
ダ ${prefix}memeindo
ダ ${prefix}darkjokes
...
ダ ${prefix}mobil
ダ ${prefix}motor
ダ ${prefix}wallpaperhacker
ダ ${prefix}wallpaperhacker2
ダ ${prefix}wallpaperharley
ダ ${prefix}wallpaperjoker
ダ ${prefix}wallpaperpubg
ダ ${prefix}wallpaperhp
ダ ${prefix}wallpaperhp2
ダ ${prefix}wallpaperkpop
ダ ${prefix}wallpaperblackpink
ダ ${prefix}wallpapergame
